...
detector = Detector(path_config='./pipeline.config', path_ckpt='./out/ckpt-49',
                    path_to_labels='./label_map.pbtxt')


image = cv2.imread('/Users/nvlhqlt3013/projects/object_detection_demo/Dataset/cmnd_quyen_111_001.jpg')
