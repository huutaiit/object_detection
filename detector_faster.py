...
model = DetectorFaster(path_to_model='./save_model/saved_model/', path_to_labels='./label_map.pbtxt')
image = cv2.imread('/Users/nvlhqlt3013/projects/object_detection_demo/Dataset/cmnd-tc.md.jpg')
start = time.time()
