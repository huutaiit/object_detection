...
class Detector(object):
    ...
    def check_if_have_zero(self,arr):
        rows = arr[0][0][0]
        return  set(rows)
...
detection_model = Detector(path_to_model='./model.tflite',
                           path_to_labels='./label_map.pbtxt',
                           nms_threshold=0.2, score_threshold=0.3)
i = cv2.imread('/Users/nvlhqlt3013/projects/cmnd/complete/test_image/test_5.jpg')
